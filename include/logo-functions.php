...
function getLoginLogoHtml() {
    ...
    <div class="logo-container" style="text-align: center; margin-bottom: 20px;">
        <div style="display: inline-block; background: linear-gradient(135deg, #0f5132 0%, #198754 100%); padding: 20px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
...
function getNavbarLogoHtml() {
    ...
    <div class="d-flex align-items-center">
        ...
        <span style="font-weight: 600; color: #0f5132;">NSTP CUTS ROTC LTS</span>
    </div>';
}

function getSidebarLogoHtml() {
    return '
    <div class="brand-link d-flex align-items-center" style="background: linear-gradient(135deg, #0f5132 0%, #198754 100%); padding: 15px;">
